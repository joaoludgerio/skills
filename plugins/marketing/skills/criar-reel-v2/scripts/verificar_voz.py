...
Calibracao de referencia: cenas com a voz certa = sim 0.70-0.92;
cenas com a voz errada = sim 0.19-0.23. Threshold default 0.5.

Requisitos: pip install sherpa-onnx; modelo em assets/speaker-embed.onnx (download no README);
referencia da voz em assets/voice-ref.wav (16k mono, ~20s da SUA voz).
...
DEFAULT_MODEL = os.environ.get("SPEAKER_EMBED_MODEL", os.path.join(SKILL_DIR, "assets", "speaker-embed.onnx"))
DEFAULT_REF = os.environ.get("VOICE_REF", os.path.join(SKILL_DIR, "assets", "voice-ref.wav"))
